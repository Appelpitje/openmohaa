...
Integrated Discord Rich Presence (RPC) support that displays your active game status on your Discord profile.
...
### CMake Build Option
To enable or disable Discord RPC at build time:
```bash
cmake -B build -DUSE_DISCORD_RPC=ON
```
